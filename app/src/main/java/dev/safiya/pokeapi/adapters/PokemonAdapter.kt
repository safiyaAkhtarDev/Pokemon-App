package dev.safiya.pokeapi.adapters
...
import dev.safiya.pokeapi.databinding.ListItemPokemonBinding
import dev.safiya.pokeapi.model.PokemonResult
import dev.safiya.pokeapi.utils.NETWORK_VIEW_TYPE
import dev.safiya.pokeapi.utils.PRODUCT_VIEW_TYPE
import dev.safiya.pokeapi.utils.getPicUrl
    ...
    inner class ViewHolder(
        ...
        fun bind(pokemonResult: PokemonResult) {
            binding.apply {
                ...
                pokemonItemNumber.text = "#" + pokemonResult.id
                var allabilities: String? = ""
                for (abilities in pokemonResult.abilities!!) {
                    allabilities += abilities.ability.name + "\n"
                }
                pokemonItemAbilities.text = allabilities
