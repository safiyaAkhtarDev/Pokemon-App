...
import dev.safiya.pokeapi.databinding.NetworkStateItemBinding

/**
 * Loading state Adapter used with paging 3 to show the state of data being loaded,
 * it shows at the footer of the adapter
 */
